...
class ProcessadorDeImagens:
    def __init__(self, app_gui):
        ...
        # Caminhos de destino fixos
        base_path = os.path.join(os.path.expanduser('~'), 'Desktop', 'script-txt')
        self.PASTA_IMAGENS_BAIXADAS = os.path.join(base_path, "imagens_pineapple_calcados")
        self.PASTA_IMAGENS_REDIMENSIONADAS = os.path.join(base_path, "imagens_redimensionadas_calcados")
        
        # Margens precisas para calçados
        self.FUNDO_TAMANHO = (1080, 1080)
        self.LIMITE_TOPO = 282
        self.LIMITE_BASE = 761
        self.LIMITE_ESQUERDA = 108
        self.LIMITE_DIREITA = 972
            ...
            for nome_arquivo in arquivos:
                if nome_arquivo.lower().endswith(('.jpg', '.jpeg', '.png', '.webp')):
                    ...
                    try:
                        ...
                        # ==========================================================
                        # ALTERAÇÃO PRINCIPAL: Alinhamento Vertical e Horizontal
                        # ==========================================================
                        # Centraliza horizontalmente
                        offset_x = self.LIMITE_ESQUERDA + (largura_util - nova_largura) // 2
                        # Alinha a base da imagem com o limite inferior (761)
                        offset_y = self.LIMITE_BASE - nova_altura
                        # ==========================================================
...
class AppGUI:
    def __init__(self, root):
        self.root = root
        root.title("Processador de Imagens (VERSÃO CALÇADOS v1.2)")
